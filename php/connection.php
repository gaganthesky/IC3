...
$value1 = $_POST['event_name'];
$value2 = $_POST['date'];
$value3 = $_POST['organization'];
$value4 = $_POST['location'];
$value5 = $_POST['event_details'];

$sql = "INSERT INTO events_temp (event_name, date, organization, location, event_details) VALUES ('$value1', '$value2', '$value3', '$value4', '$value5')";
